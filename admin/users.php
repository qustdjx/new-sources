...
function action_batch_remove ()
{
	...
	if(isset($_POST['checkboxes']))
	{
		...
		/* 青岛火一五信息科技有限公司huo15.com 日期：2017/1/23 */
		$sql = "DELETE FROM " . $ecs->table('weixin_user') . "WHERE ecuid " .db_create_in($_POST['checkboxes']);
		$res = $db->query($sql);
		/* 青岛火一五信息科技有限公司huo15.com 日期：2017/1/23 end */
...
function action_remove ()
{
	...
	if($issupplier>0){
		...
		/* 青岛火一五信息科技有限公司huo15.com 日期：2017/1/23 */
		$sql = "DELETE FROM " . $ecs->table('weixin_user') . "WHERE ecuid=" . $_GET["id"];
		$res = $db->query($sql);
		/* 青岛火一五信息科技有限公司huo15.com 日期：2017/1/23 end */
